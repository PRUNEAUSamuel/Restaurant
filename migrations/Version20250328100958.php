 ...
 */
final class Version20250328100958 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD user_id INT DEFAULT NULL, DROP user_id_id');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE comments ADD user_id_id INT NOT NULL, DROP user_id');
