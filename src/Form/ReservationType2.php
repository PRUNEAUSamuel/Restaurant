    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('arrivalTime', ChoiceType::class, [
                ...
                'label_attr' => [
                    'class' => 'lg:text-lg block mt-3 text-sm font-medium',
                ],
                'attr' => [
                    'class' => 'lg:text-lg mt-4 mb-6 arrival-time-select bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-1.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white',
                ],
            ]);
